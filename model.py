...
from train import dim_channel, dim_W3
...
class DCGAN():
    def __init__(
        ...
        self.gen_W1 = tf.compat.v1.trainable_variables(tf.random.normal([dim_z+dim_y, dim_W1], stddev=0.02), name='gen_W1')
        self.gen_W2 = tf.compat.v1.trainable_variables(tf.random.normal([dim_W1+dim_y, dim_W2*7*7], stddev=0.02), name='gen_W2')
        self.gen_W3 = tf.compat.v1.trainable_variables(tf.random.normal([5,5,dim_W3,dim_W2+dim_y], stddev=0.02), name='gen_W3')
        self.gen_W4 = tf.compat.v1.trainable_variables(tf.random.normal([5,5,dim_channel,dim_W3+dim_y], stddev=0.02), name='gen_W4')

        self.discrim_W1 = tf.compat.v1.trainable_variables(tf.random.normal([5,5,dim_channel+dim_y,dim_W3], stddev=0.02), name='discrim_W1')
        self.discrim_W2 = tf.compat.v1.trainable_variables(tf.random.normal([5,5,dim_W3+dim_y,dim_W2], stddev=0.02), name='discrim_W2')
        self.discrim_W3 = tf.compat.v1.trainable_variables(tf.random.normal([dim_W2*7*7+dim_y,dim_W1], stddev=0.02), name='discrim_W3')
        self.discrim_W4 = tf.compat.v1.trainable_variables(tf.random.normal([dim_W1+dim_y,1], stddev=0.02), name='discrim_W4')
